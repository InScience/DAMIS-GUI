...
class PageController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('BaseStaticBundle:Page')->findBy(array('type' => 1), array('position' => 'ASC'));;
        $notTopMenu = $em->getRepository('BaseStaticBundle:Page')->findBy(array('type' => 0), array('position' => 'ASC'));;
