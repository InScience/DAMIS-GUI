...
class WorkflowtaskRepository extends EntityRepository
{
    ...
    public function getRunnableTasks($limit)
    {
        $query = $this->createQueryBuilder('w')
            ...
            ->leftJoin('Damis\EntitiesBundle\Entity\Parametervalue', 'pv', 'with', 'pv.workflowtask = w')
            ->leftJoin('Damis\EntitiesBundle\Entity\Pvalueoutpvaluein', 'pio', 'with', 'pv.parametervalueid = pio.inparametervalue')
            ->andWhere('e.status = 2')
